                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent intent;
                            if(sharedPreferences.contains(getString(R.string.Age)) && sharedPreferences.contains(getString(R.string.CalorieGoal))){
                                intent = new Intent(getApplicationContext(), MainActivity.class);
                            }
                            else{
                                intent = new Intent(getApplicationContext(), BiometricInputActivity.class);
                            }
